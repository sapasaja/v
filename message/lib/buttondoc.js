...
async run(jid, zyn, quoted = {}) {
    const filePath = './message/lib/media/ZynMg.jpg'; // 300 x 300 puqi
    ...
    await zyn.relayMessage(msg.key.remoteJid, msg.message, { messageId: msg.key.id });
    return msg;
}
}
